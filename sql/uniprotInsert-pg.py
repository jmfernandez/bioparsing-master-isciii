...
'''
dbhost='localhost'	# El servidor, en este caso vuestro portátil
dbname='masterdb'	# El nombre de la base de datos, que tendréis que cambiarlo
dbuser='masteruser'	# Vuestro nombre de usuario
dbpass='masterpass'	# La contraseña para vuestro nombre de usuario
